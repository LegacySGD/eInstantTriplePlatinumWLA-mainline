...
public class TriplePlatinumWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TriplePlatinumWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TriplePlatinumWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TriplePlatinumWLAIW/InitOutcome.xml").getDocumentElement();
